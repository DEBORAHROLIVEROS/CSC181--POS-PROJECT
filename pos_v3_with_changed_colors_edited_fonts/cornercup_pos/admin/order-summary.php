            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                                ...
                                <div class="table-responsive mb-3">
                                    <table style="width: 100%;" cellpadding="5">
                                        ...
                                        <tbody>
                                            ...
                                            <?php endforeach; ?>
                                            <tr>
                                                <td colspan="4" align="end" style="font-family: 'Times New Roman', sans-serif; font-weight: bold;">Grand Total:</td>
                    ...
                    <div class="mt-4 text-end">
                        <button type="button" class="btn btn-primary px-4 mx-1" id="saveOrder" style="background-color: #243E58;">Save</button>
